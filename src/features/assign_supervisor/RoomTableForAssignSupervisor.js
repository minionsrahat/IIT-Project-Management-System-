...
const RoomTableForAssignSupervisor = ({ rooms, get_teams_info }) => {
                            ...
                            return (
                                <tr key={row.room_id}>
                                    ...
                                    <td>
                                        {
                                            row.table_created === 0 ? <>
                                                <button disabled className="btn mr-1" >Team Not Created</button>
                                            </> : <>
                                                <button  onClick={() => get_teams_info(row.room_id)}  className="btn mr-1 btn-success" >Get Teams</button>
                                            </>
                                        }
...
export default RoomTableForAssignSupervisor;