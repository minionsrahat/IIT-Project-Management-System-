...
const ResetSupervisorTable = ({ rooms, unlockTeams}) => {
                            ...
                            return (
                                <tr key={row.room_id}>
                                    ...
                                    <td>
                                        ...
                                        row.supervisor_assigned ===0?<button disabled className="btn mr-1" >Supervisor Not Assigned</button> : <button onClick={() => unlockTeams(row.room_id)} className="btn mr-1" >Reset</button>}
...
export default ResetSupervisorTable;